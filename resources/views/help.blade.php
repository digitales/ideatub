    ...
    <div id="mcp" class="mt-8 space-y-6">
        ...
        <div id="plans" class="rounded-2xl border border-memory-violet/20 bg-white/80 backdrop-blur p-6 shadow-[0_4px_24px_rgba(109,106,247,0.08)]">
            ...
            <ul class="text-sm text-slate-brand mb-4 space-y-2 list-disc list-inside">
                ...
                <li><strong class="text-deep-indigo">Share documents</strong> — From an eligible long-form document (Stream card or thought detail), or from <a href="{{ route('shared-research.index') }}" class="text-memory-violet hover:underline">Shared documents</a>, use <strong>Share</strong> or <strong>Create share link</strong> to get a readonly link. You can optionally set a password and expiry.</li>
                <li><strong class="text-deep-indigo">Projects</strong> — Use <a href="{{ route('projects.index') }}" class="text-memory-violet hover:underline">Projects</a> to group thoughts; on a thought’s detail page you can add it to projects and create <strong>typed links</strong> to other thoughts. Open a project’s <strong>Graph</strong> to see members and links; <strong>Share</strong> on a project creates a read-only hub (plus “read all” and per-item pages), with optional password and expiry, similar to shared documents.</li>
