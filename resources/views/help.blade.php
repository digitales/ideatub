    ...
    <div id="mcp" class="mt-8 space-y-6">
        ...
        <div id="plans" class="rounded-2xl border border-memory-violet/20 bg-white/80 backdrop-blur p-6 shadow-[0_4px_24px_rgba(109,106,247,0.08)]">
            ...
            <ul class="text-sm text-slate-brand mb-4 space-y-2 list-disc list-inside">
                ...
                <li><strong class="text-deep-indigo">Share documents</strong> — On an eligible long-form document, use <strong>Share</strong> on the Stream card or thought detail page to create and copy a readonly link in place (optional password and expiry). Manage all links from <a href="{{ route('shared-research.index') }}" class="text-memory-violet hover:underline">Shared documents</a>.</li>
