...
@section('description', 'IdeaTub is your thinking space. Capture thoughts, find them with semantic search, and optionally mirror to Evernote. Use in the browser or via MCP.')
...
<script type="application/ld+json">
{
    ...
    "description": "Capture and search thoughts with semantic search. Optional Evernote mirror and MCP.",
    "url": "{{ url('/') }}",
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="rounded-2xl border border-memory-violet/10 bg-white/80 backdrop-blur p-6 shadow-[0_4px_24px_rgba(109,106,247,0.06)]">
                ...
                <h3 class="text-lg font-semibold text-deep-indigo mb-2">MCP & Evernote</h3>
                <p class="text-sm text-slate-brand leading-relaxed">Use from Claude, Cursor, or other MCP clients. Optionally mirror thoughts to Evernote.</p>
            </div>
        </div>
    </div>
</div>
