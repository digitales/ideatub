...
@section('title', $promptLabel.' — Panning for Gold — Help — IdeaTub')

@section('content')
<div class="max-w-[600px] mx-auto px-6 pt-16 pb-24">
    <p class="text-sm text-slate-brand mb-4">
        <a href="{{ route('help.panning-for-gold.index') }}" class="text-memory-violet hover:underline">← Panning for Gold prompts</a>
    </p>
    ...
    <p class="text-sm text-slate-brand mb-6">
        <a href="{{ route('help.panning-for-gold.download-one', $promptSlug) }}" class="text-memory-violet hover:underline font-medium">Download</a>
    </p>
