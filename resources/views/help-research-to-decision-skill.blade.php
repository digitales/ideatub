...
@section('title', $skillLabel.' — Research-to-decision skills — Help — IdeaTub')
...
<div class="max-w-[600px] mx-auto px-6 pt-16 pb-24">
    ...
    <h1 class="text-[28px] font-semibold text-deep-indigo leading-snug mb-2">{{ $skillLabel }}</h1>
    <p class="text-sm text-slate-brand mb-6">
        <a href="{{ route('help.research-to-decision.skills.download-one', $skillSlug) }}" class="text-memory-violet hover:underline font-medium">Download SKILL.md</a>
    </p>
