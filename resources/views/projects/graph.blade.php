...
<div class="max-w-6xl mx-auto px-6 md:px-8 pt-16 pb-24 space-y-4">
    ...
    <div id="project-graph-canvas" class="w-full rounded-2xl border border-memory-violet/20 bg-white/80 shadow-[0_4px_24px_rgba(109,106,247,0.08)]" style="min-height: 420px;"></div>
