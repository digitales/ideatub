...
- Defined research question and source set.
- Optional **IdeaTub MCP** for `search_thoughts` / `capture_plan`: `https://ideatub.com/help#mcp`.
...
- “What can we conclude from this packet?”
...
**Reads like per-source summaries:** Add a real synthesis question or decision context.

**Contradictions disappeared:** Keep disagreement visible unless stronger evidence resolves it.

**Inflated confidence:** Match confidence to evidence quality.
