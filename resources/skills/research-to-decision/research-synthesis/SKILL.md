...
description: |
 ...
 question, a defined audience, and a set of source materials. Optional IdeaTub MCP
...
<!--
  IdeaTub distribution — adapted from OB1 research-synthesis.
  Upstream: https://github.com/NateBJones-Projects/OB1/tree/main/skills/research-synthesis
-->
...
7. Optionally use IdeaTub MCP.
 - Run **`search_thoughts`** for prior related notes before starting.
 - Capture the final synthesis or highest-value findings with **`capture_plan`** (`doc_type`: `research`; reuse **`plan_slug`**) after completion.
