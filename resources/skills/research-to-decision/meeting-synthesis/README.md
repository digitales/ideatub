...
This folder matches [OB1 `skills/meeting-synthesis`](https://github.com/NateBJones-Projects/OB1/tree/main/skills/meeting-synthesis). IdeaTub ships **`SKILL.md`** with IdeaTub MCP URLs plus **`README.md`** and **`metadata.json`**.
...
Copy **`SKILL.md`** into `~/.claude/skills/meeting-synthesis/` (or your client’s equivalent). Optional: `README.md`, `metadata.json`.
