...
- Real diligence inputs—not just a company name.
- Optional **IdeaTub MCP** to capture the memo or summary.
...
- “Draft a deal memo” / “Write the IC memo”
...
**Polished but thin:** Feed actual research, model review, and meeting outputs—not titles only.

**Hides uncertainty:** Keep evidence gaps visible in line with `SKILL.md`.

**Used too early:** Run `research-synthesis` (and model review if needed) first.
