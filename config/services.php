...
return [
    ...
    'openrouter' => [
        ...
        'embedding_max_tokens' => (int) env('OPENROUTER_EMBEDDING_MAX_TOKENS', 8192),
        ...
        'embedding_proactive_chars_per_token' => (float) env('OPENROUTER_EMBEDDING_PROACTIVE_CHARS_PER_TOKEN', 1.0),
